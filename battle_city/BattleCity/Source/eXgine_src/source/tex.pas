...
begin
  ...
  begin
    ...
    log('Create ID: ' + IntToStr(Result) + #9 + Name);
  end;
end;
...
begin
  ...
  try
    ...
    log('Loaded ID: ' + IntToStr(Result) + #9 + FileName);
  except
...
begin
  ...
  try
    ...
    log('Loaded ID: ' + IntToStr(Result) + #9 + Name);
  except
...
procedure TTex.log(Text: string);
begin
